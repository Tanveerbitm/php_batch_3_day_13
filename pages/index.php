                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="action.php" method="post">
                            ...
                            <div class="form-group row">
                                <div class="alert alert-primary col-md-12 text-center d-<?php echo isset($msg)?'block':'none' ;?>" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <label class="col-form-label mr-5"><input type="radio" class="form-control" name="odd_even" value="1"/>ODD</label>
                                    <label class="col-form-label"><input type="radio" class="form-control " name="odd_even" value="2"/>EVEN</label>
                                </div>
                            </div>
